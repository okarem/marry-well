  ...
  return (
    <div>
      ...
      <div id="current-day-info" class="color">
        ...
        <div>
          <h2 id="current-year" class="center default-cursor">
            2019
          </h2>
        </div>
        ...
        <div class="time">
          <span> 22 </span>: <span> 55 </span>:<span> 23 </span>
        </div>
      ...
      <div id="calender">
        <h1 id="app-name-portrait" class="center ">
          JSCalender
        </h1>
          ...
          <thead class="color">
            <tr>
              <th colspan="7" class="border-color">
                <h4 id="cal-year" contenteditable="true">
                  2018
                </h4>
                <div>
